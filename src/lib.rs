...
#[derive(Debug)]
pub struct MoralStackProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MoralStackProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MoralStack processing");
    
    let mut processor = MoralStackProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MoralStackProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MoralStackProcessor::new(false);
